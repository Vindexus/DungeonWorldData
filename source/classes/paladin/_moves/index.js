module.exports = 
{
  ...
  "staunch_defender": {
    ...
    "description": "When you {{move 'defend'}} you always get +1 hold, even on a 6-."
  },
  "setup_strike": {
    "name": "Setup Strike",
    "key": "setup_strike",
    "description": "When you {{move 'hack_and_slash'}}, choose an ally. Their next attack against your target does +1d4 damage."
  },
  "holy_protection": {
  ...
  "tandem_strike": {
    ...
    "description": "When you {{move 'hack_and_slash'}}, choose an ally. Their next attack against your target does +1d4 damage and they take +1 forward against them."
  },
  "divine_protection": {
  ...
  "divine_authority": {
    ...
    "description": "Take +1 to order hirelings. When you roll a 12+ the hireling transcends their moment of fear and doubt and carries out your order with particular effectiveness or efficiency."
  },
  "perfect_hospitaller": {
  ...
  "perfect_knight": {
    "name": "Perfect Knight",
    "key": "perfect_knight",
    "description": "When you {{move 'quest'}} you choose three boons instead of two."
  }
}