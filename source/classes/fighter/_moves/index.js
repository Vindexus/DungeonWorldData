module.exports = 
{
  ...
  "fighter_halfling": {
    ...
    "description": "When you {{move 'defy_danger'}} and use your small size to your advantage, take +1."
  },
  "fighter_human": {
    "name": "Human",
    "key": "fighter_human",
  ...
  "scent_of_blood": {
    "name": "Scent of Blood",
    "key": "scent_of_blood",
    "description": "When you {{move 'hack_and_slash'}} an enemy, your next attack against that same foe deals +1d4 damage."
  },
  "multiclass_dabbler": {
  ...
  "taste_of_blood": {
    ...
    "description": "When you {{move 'hack_and_slash'}} an enemy, your next attack against that same foe deals +1d8 damage."
  },
  "multiclass_initiate": {
    "name": "Multiclass Initiate",
    "key": "multiclass_initiate",
    "replaces": "multiclass_dabbler",
    "description": "Get one move from another class. Treat your level as one lower for choosing the move."
  },
  "steel_hide": {
    "name": "Steel Hide",
  ...
  "superior_warrior": {
    ...
    "description": "When you {{move 'hack_and_slash'}} on a 12+ you deal your damage, avoid their attack, and impress, dismay, or frighten your enemy."
  }
}